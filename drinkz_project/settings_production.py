...
STATIC_ROOT = os.path.join(BASE_DIR, "..", "www", "static")#'/files/static'
...
SECRET_KEY = '10&pj7z6hc#2i^_$m2d$$b^2^ypb88k_dx$qgd#i#6a!37m36q'
...
ROOT_URLCONF = 'drinkz_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'drinkz_project.wsgi.application'
